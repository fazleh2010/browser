...
public class RdfReader_1 implements IATE {

    private String MODEL_TYPE;
    private LanguageManager languageInfo;
    private DataBaseTemp dataBaseTemp;

    public RdfReader_1(String browser,DataBaseTemp dataBaseTemp,LanguageManager languageInfo, String MODEL_TYPE, String MODEL_EXTENSION) throws Exception {
